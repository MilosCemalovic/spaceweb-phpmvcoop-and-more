...
<?php if(isset($msg)) { ?>
  ...
  <h6 class="heading-6 heading-6--msg"> <?php echo $msg; ?> </h6>
...
<?php if(array_key_exists('fullname', $errors)) { ?>
  ...
  <h6 class="heading-6 heading-6--errors"> <?php echo $errors['fullname'] ?> </h6>
...
<?php if(array_key_exists('email', $errors)) { ?>
  ...
  <h6 class="heading-6 heading-6--errors"> <?php echo $errors['email'] ?> </h6>
...
<?php if(array_key_exists('group', $errors)) { ?>
  ...
  <h6 class="heading-6 heading-6--errors"> <?php echo $errors['group'] ?> </h6>
